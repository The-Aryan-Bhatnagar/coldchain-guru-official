        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-primary-foreground/80">
                ...
                <div className="flex flex-col">
                  <span>+91 9837493412</span>
                  <span>+91 7351712217</span>
                </div>
              </li>
              <li className="flex items-start gap-2 text-sm text-primary-foreground/80">
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.linkedin.com/in/anand-bhatnagar-220b38103" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-secondary transition-colors" aria-label="LinkedIn Profile">
                <Linkedin className="h-5 w-5" />
              </a>
              <a href="https://www.instagram.com/tempratureguru" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-secondary transition-colors" aria-label="Instagram Profile">
